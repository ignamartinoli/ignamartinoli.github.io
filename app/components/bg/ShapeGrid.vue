<!--
  ...
  Contains a LOCAL EDIT (vignette colour made a prop); see ./README.md.
-->
...
function initCanvas() {
  ...
  const drawGrid = () => {
    ...
    // LOCAL EDIT: was hardcoded '#14110E', which is a dark vignette on a light page.
