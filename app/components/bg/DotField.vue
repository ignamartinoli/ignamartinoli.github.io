<!--
  ...
  Contains a LOCAL EDIT (cursor drift on scroll); see ./README.md.
-->
...
function setupCanvas() {
  ...
  function doResize() {
    ...
    size = {
      w,
      h,
      // LOCAL EDIT: was `+ window.scrollX/Y`, captured once, so the cursor drifted by
      // the scroll delta. clientX/clientY below are viewport-relative like rect.
      offsetX: rect.left,
      offsetY: rect.top
    };
